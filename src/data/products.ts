...
export const products: Product[] = [
  ...
  },
  {
    ...
    specs: ['Width: 500mm', 'Thickness: 23 microns', 'Weight: 2.7kg', 'Material: LLDPE', 'Colour: Black'],
    categoryId: 'cat-7',
    categorySlug: 'stretch-film',
  ...
  },
  {
    ...
    specs: ['Width: 15mm', 'Weight: 1.8kg', 'Material: Polypropylene (PP)', 'Type: Mixed / Single Color'],
    categoryId: 'cat-17',
    categorySlug: 'strapping-bands',
    images: [
