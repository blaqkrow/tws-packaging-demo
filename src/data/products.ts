...
export const products: Product[] = [
  ...
  // ═══════════════════════════════════════
  {
    ...
    specs: ['Material: OPP (Oriented Polypropylene)', 'Colour: Transparent', 'Packing: 48mm = 6 rolls/bundle, 72mm = 4 rolls/bundle'],
    categoryId: 'cat-2',
  ...
  },
  {
    ...
    description: 'Strong plastic packing tape used for sealing cartons. Good adhesion, durable, and cost-effective for general packaging.',
    specs: ['Material: OPP (Oriented Polypropylene)', 'Colour: Brown', 'Packing: 48mm = 6 rolls/bundle, 72mm = 4 rolls/bundle'],
    categoryId: 'cat-2',
    categorySlug: 'opp-tapes',
  ...
  },
  {
    ...
    specs: ['Material: OPP (Oriented Polypropylene)', 'Colour: Yellow / Blue / Red / Black', 'Packing: 48mm = 6 rolls/bundle, 72mm = 4 rolls/bundle'],
    categoryId: 'cat-2',
    categorySlug: 'opp-tapes',
    images: [
