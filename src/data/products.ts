...
export const products: Product[] = [
  ...
  {
    id: 'prod-1',
    name: 'PVC Tape (Yellow)',
    slug: 'pvc-tape-yellow',
    description: 'High-visibility yellow PVC tape for floor marking, colour coding, and general bundling. Strong adhesive with clean removal.',
    specs: ['Width: 48mm', 'Length: 33m', 'Material: PVC', 'Adhesive: Rubber-based'],
    categoryId: 'cat-1',
    categorySlug: 'pvc-tapes',
    images: ['/images/products-new/pvc-tape-product.png', '/images/products-new/pvc-tape.png'],
    variants: [{ code: 'FMT-4833Y', spec: '48mm × 33m — Yellow' }],
    isFeatured: false,
    isActive: true,
  },
  {
    ...
    name: 'PVC Tape (Blue)',
    slug: 'pvc-tape-blue',
    description: 'Blue PVC tape for colour identification, lane marking, and bundling applications. Durable and tear-resistant.',
    specs: ['Width: 48mm', 'Length: 33m', 'Material: PVC', 'Adhesive: Rubber-based'],
    categoryId: 'cat-1',
    categorySlug: 'pvc-tapes',
    images: ['/images/products-new/pvc-tape-product.png', '/images/products-new/pvc-tape.png'],
    variants: [{ code: 'FMT-4833B', spec: '48mm × 33m — Blue' }],
    isFeatured: false,
    isActive: true,
  },
  {
    ...
    name: 'PVC Tape (Red)',
    slug: 'pvc-tape-red',
    description: 'Red PVC tape for hazard marking, colour coding, and attention-drawing applications. Excellent adhesion on most surfaces.',
    specs: ['Width: 48mm', 'Length: 33m', 'Material: PVC', 'Adhesive: Rubber-based'],
    categoryId: 'cat-1',
    categorySlug: 'pvc-tapes',
    images: ['/images/products-new/pvc-tape-product.png', '/images/products-new/pvc-tape.png'],
    variants: [{ code: 'FMT-4833R', spec: '48mm × 33m — Red' }],
    isFeatured: true,
    isActive: true,
  },
  ...
  // ═══════════════════════════════════════
  {
    ...
    specs: ['Material: OPP (Oriented Polypropylene)', 'Adhesive: Acrylic', 'Colour: Transparent'],
    categoryId: 'cat-2',
  ...
  // ─── SMART OPP TAPES — BROWN ──────────
  {
    ...
    specs: ['Material: OPP (Oriented Polypropylene)', 'Adhesive: Acrylic', 'Colour: Brown'],
    categoryId: 'cat-2',
    categorySlug: 'opp-tapes',
  ...
  // ═══════════════════════════════════════
  {
    ...
    specs: ['Material: OPP (Oriented Polypropylene)', 'Adhesive: Acrylic', 'Sizes: Same as Smart OPP tape', 'Minimum Order: Contact us for MOQ'],
    categoryId: 'cat-3',
  ...
  },
  {
    ...
    categoryId: 'cat-7',
    categorySlug: 'stretch-film',
    images: ['/images/products-new/stretch-film-black-product.jpg', '/images/products-new/stretch-film.png'],
    variants: [
  ...
  // ═══════════════════════════════════════
  {
    ...
    variants: [
      { code: 'NP-21531W', spec: '21.5" × 31" (Wing Chang stock)' },
  ...
  },
  {
    ...
    categoryId: 'cat-17',
    categorySlug: 'strapping-bands',
    images: ['/images/products-new/strapping-tensioner-product.jpg', '/images/products-new/strapping-tensioner.jpeg'],
    variants: [
  ...
  },
  {
    ...
    categoryId: 'cat-17',
    categorySlug: 'strapping-bands',
    images: ['/images/products-new/strapping-sealer-product.jpg', '/images/products-new/strapping-sealer.png'],
    variants: [
